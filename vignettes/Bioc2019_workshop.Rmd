...
library(MoonlightR)
FiguresPath <- system.file(package = "Bioc2019PanCancerStudy", "vignettes")
```
...
include_graphics(file.path(FiguresPath, "TCGA_BRCA_dataPrep_Norm_boxplot.png"))
```
...
include_graphics(file.path(FiguresPath, "Moonlight_pipeline1.png"))
```

```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "Moonlight_pipeline2.png"))
```
...
include_graphics(file.path(FiguresPath, "DEGs_volcano.png"))
```
...
```{r, fig.width=6, fig.height=4, echo = FALSE, fig.align="center",hide=TRUE, message=FALSE,warning=FALSE}
include_graphics(file.path(FiguresPath, "FEAplot.png"))
```
...
```{r, fig.width=6, fig.height=4, echo = FALSE, fig.align="center",hide=TRUE, message=FALSE,warning=FALSE}
include_graphics(file.path(FiguresPath, "URAplot.png"))
```
...
```{r, fig.width=6, fig.height=4, echo = FALSE, fig.align="center",hide=TRUE, message=FALSE,warning=FALSE}
include_graphics(file.path(FiguresPath, "Moonlight_PanCancer18_circos.png"))
```
...
include_graphics(file.path(FiguresPath, "ImmuneSubtypes_workflow.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "TCGA_KIRC_ImmuneSubtypes_survival.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "stemness_methodology.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "Validation_mRNASi_Nazor.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "Validation_mRNASi_IHEC.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "TCGA_BRCA_mRNASi_TP_NT.png"))
```

The result from TCGAanalyze_Stemness with molecular subtypes is shown below:
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "TCGA_BRCA_mRNASi_subtypes.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "TCGA_LGG_GBM_mRNASi_subtypes.png"))
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
include_graphics(file.path(FiguresPath, "TCGA_LGG_GBM_mRNASi_survival.png"))
```
