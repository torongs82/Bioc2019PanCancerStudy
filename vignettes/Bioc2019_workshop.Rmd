...
grid.raster(
  readPNG("figs/TCGA_BRCA_dataPrep_Norm_boxplot.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/Moonlight_pipeline1.png")
)
```

```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/Moonlight_pipeline2.png")
)
```
...
grid.raster(
  readPNG("figs/ImmuneSubtypes_workflow.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/TCGA_KIRC_ImmuneSubtypes_survival.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/stemness_methodology.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/Validation_mRNASi_Nazor.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/Validation_mRNASi_IHEC.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/TCGA_BRCA_mRNASi_TP_NT.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/TCGA_BRCA_mRNASi_subtypes.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/TCGA_LGG_GBM_mRNASi_subtypes.png")
)
```
...
```{r, fig.width=6, fig.height=4, echo=FALSE, fig.align="center"}
grid.raster(
  readPNG("figs/TCGA_LGG_GBM_mRNASi_survival.png")
)
```
